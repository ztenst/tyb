...
<div class="form-group">
    <label class="col-md-2 control-label">室<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'bedroom', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'bedroom') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">厅<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'livingroom', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'livingroom') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">卫<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'bathroom', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'bathroom') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">面积<span class="required" aria-required="true">*</span></label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'size', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'size') ?></div>
</div>
<div class="form-group">
