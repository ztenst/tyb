<?php
	$this->pageTitle=$house->title.'户型';
	?>
    <div class="table-toolbar">
    <div class="pull-right">
        <a href="<?php echo $this->createAbsoluteUrl('edithx',['hid'=>$_GET['hid']]) ?>" class="btn blue">
...
<table class="table table-bordered table-striped table-condensed flip-content">
    ...
    <?php foreach($infos as $v): ?>
        <tr>
            ...
            <td style="text-align:center;vertical-align: middle" class="text-center"><?php echo $v->title ?></td>
            <td style="text-align:center;vertical-align: middle" class="text-center"><?=strstr($v->image,'http')?$v->image:('<img width="100px" height="70px" src="'.ImageTools::fixImage($v->image).'">')?></td>
            <td style="text-align:center;vertical-align: middle" class="text-center"><?php echo $v->bedroom.'/'.$v->livingroom.'/'.$v->bathroom?></td>
            ...
            <td style="text-align:center;vertical-align: middle">
                <a href="<?php echo $this->createUrl('edithx',array('id'=>$v->id,'hid'=>$_GET['hid'])); ?>" class="btn default btn-xs green"><i class="fa fa-edit"></i> 修改 </a>
