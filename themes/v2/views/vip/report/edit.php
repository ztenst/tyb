...
<div class="form-group">
    <label class="col-md-2 control-label">举报者</label>
    <div class="col-md-4">
...
<div class="form-group">
    <label class="col-md-2 control-label">举报理由</label>
    <div class="col-md-4">
        <?php echo $form->textField($article, 'reason', array('class' => 'form-control')); ?>
    </div>
    <div class="col-md-2"><?php echo $form->error($article, 'reason') ?></div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">状态</label>
    <div class="col-md-4">
        <?php echo $form->radioButtonList($article, 'status', ReportExt::$status, array('separator' => '')); ?>
    </div>
