...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            ...
            <div class="form-group">
                <?php echo CHtml::dropDownList('cate',$cate,$cates,array('class'=>'form-control chose_select','encode'=>false,'prompt'=>'--选择主队--')); ?>
            </div>
            <div class="form-group">
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tr>
        ...
        <th class="text-center">联赛名称</th>
        <th class="text-center">比赛时间</th>
        <th class="text-center">主队</th>
        <th class="text-center">主队进球数</th>
        <th class="text-center">客队进球数</th>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->league?$v->league->name:'-'?></td>
            <td class="text-center"><?=date('Y-m-d',$v->time)?></td>
            <td class="text-center"><?=$v->home_name?></td>
            <td class="text-center"><?=$v->home_score?></td>
            <td class="text-center"><?=$v->visitor_score?></td>
            <td class="text-center"><?=$v->visitor_name?></td>
