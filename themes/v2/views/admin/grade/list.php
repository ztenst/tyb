...
<div class="table-toolbar">
    <div class="btn-group pull-left">
        <form class="form-inline">
            <div class="form-group">
                <?php echo CHtml::dropDownList('type',$type,array('title'=>'评分'),array('class'=>'form-control','encode'=>false)); ?>
            </div>
            <div class="form-group">
   ...
   <table class="table table-bordered table-striped table-condensed flip-content table-hover">
    ...
    <tr>
        ...
        <th class="text-center">评分者</th>
        <th class="text-center">被评分者</th>
    ...
    <?php foreach($infos as $k=>$v): ?>
        <tr>
            ...
            <td class="text-center"><?=$v->buser?$v->buser->name:''?></td>
            <td class="text-center"><?=$v->is_nm?"匿名":"公开"?></td>     
