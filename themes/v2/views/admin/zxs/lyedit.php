...
<div class="form-group">
    <label class="col-md-2 control-label">选择领域</label>
    <div class="col-md-4">
    <input type="hidden" class="form-control" name="UserTagExt[uid]" readonly="readonly" value="<?=$info->id?>">
        <?php echo $form->dropDownList($article, 'tid',  CHtml::listData(TagExt::model()->findAll("cate='ly' and status=1"),'id','name'), array('class'=>'form-control select2','empty'=>'无')); ?>
    </div>
...
<div class="form-actions">
    <div class="row">
        <div class="col-md-offset-3 col-md-9">
            ...
            <?php echo CHtml::link('返回',$this->createUrl('lylist',['id'=>$info->id]), array('class' => 'btn default')) ?>
        </div>
    </div>
</div>
