...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php $this->widget('FileUpload',array('model'=>$article,'attribute'=>'url','inputName'=>'img','width'=>400,'height'=>300)); ?>
...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'type', Yii::app()->params['imageTag'], array('class' => 'form-control', 'encode' => false)); ?>
    </div>
