...
<div class="form-group">
    ...
    <div class="col-md-4">
        <?php echo $form->dropDownList($article, 'related_id', CHtml::listData(ProductExt::model()->normal()->findAll(),'id','name'), array('class' => 'form-control select2', 'encode' => false,'empty'=>'请选择')); ?>
    </div>
