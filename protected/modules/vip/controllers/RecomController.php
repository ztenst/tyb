 ...
 * 推荐控制器
 */
class RecomController extends VipController{
	...
	public function actionEdit($id='',$type='1',$rid='')
	{
		if(!$rid) {
		...
		$this->render('edit',['cates'=>Yii::app()->params['recomCate'],'article'=>$info,'type'=>$type,'rid'=>$rid]);
	}
}