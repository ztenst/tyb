...
class UserTime extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('uid, week, begin, end, timed, created, updated', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, uid, week, begin, end, timed, created, updated', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('timed',$this->timed);
	 ...
	 * @return UserTime the static model class
	 */
