...
/**
 * This is the model class for table "recom".
 *
 * The followings are the available columns in table 'recom':
 * @property integer $id
 ...
 */
class Recom extends CActiveRecord
{
	/**
	 ...
	 * @return Recom the static model class
	 */
